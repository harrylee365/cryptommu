                             ...
                             Arg1CallbackBase<uint64_t>* accessViolation)
{
  ...
  if (numEntries > 0) {
    ...
    //printf("Infinite memeory Instanitated\n");
  }
...
void
/*CRyptoMMU: Translation request returned from Full IOMMU*/
...
/* CryptoMMU: Full IOMMU doesn't have private TLB */
void
DMAController::translateTiming(TransferData* td)
{
  ...
  onTLBMiss->Call(vp_base); /*All accesses goes to IOTLB*/
