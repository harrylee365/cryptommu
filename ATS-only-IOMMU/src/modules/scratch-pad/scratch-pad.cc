...
ScratchPadHandle* CreateNewScratchPad()
{
  ...
  //std::cout << "size of scratchpad handle" << sizeof(ScratchPadHandle) << std::endl;
...
read_sp(ScratchPadHandle* obj, uint64_t address, void* rd, unsigned int size)
{
  ...
  //std::cout << "Read size in scratch pad memory" << size << std::endl;
...
write_sp(ScratchPadHandle* obj, uint64_t address, const void* wr, unsigned int size)
{
  ...
  //std::cout << "Write size in scratch pad memory" << size << std::endl;
  for (unsigned int i = 0; i < size; i++) {
...
CreateScratchPadInterface()
{
  ...
  //std::cout << "size of scratchpad interface" << sizeof(scratch_pad_interface_t) << std::endl;
